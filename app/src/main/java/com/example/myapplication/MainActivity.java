...
//        calendarView.addDecorator(new DisableDayDecorator());
        ...
        // 服用済みの日付をセット
        HashSet<CalendarDay> medicineTakenDates2 = new HashSet<>();
        medicineTakenDates2.add(CalendarDay.from(2024, 10, 17)); // 例: 2024年10月10日
        medicineTakenDates2.add(CalendarDay.from(2024, 10, 18)); // 例: 2024年10月11日

        // デコレーターを追加
        calendarView.addDecorator(new MedicineTakenDecorator(medicineTakenDates2));
